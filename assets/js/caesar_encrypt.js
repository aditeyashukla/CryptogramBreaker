/*function csr_ncrpt()
  {
	  ...
	  var pos = document.getElementById('num').value;
	  ...
	  for ( var i=0; i<text.length; i++ )
	  {
		  ...
		  if ( position_small>-1 )
			  if ( position>-1 )
				  character_new = alphabet.charAt( position + pos );

			  else
				  character_new = alphabet.charAt( position_small + pos ).toUpperCase();
		  else
			  character_new = character;

		  if(position>22)
					character_new = alphabet.charAt( position - 23);
